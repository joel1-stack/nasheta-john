...
export class BlogListComponent implements OnInit {
  ...
  posts: BlogPost[] = [
    { slug: 'kenya-sports-betting-2026', title: "Why Kenya's Sports Betting Market Keeps Growing in 2026", excerpt: 'Mobile penetration, Premier League obsession, and a young audience are reshaping operator strategy.', image: 'assets/images/blog-kenya.jpg', date: new Date('2026-05-10'), readTime: 10, author: 'Nasheta John', views: 2847, categories: ['African Market', 'Sports Betting'] },
    { slug: 'fair-casino-site', title: 'How to Spot a Fair Casino Site Before You Deposit', excerpt: 'Licensing checks, RTP transparency, payment method signals — the practical player checklist.', image: 'assets/images/blog-casino.jpg', date: new Date('2026-05-08'), readTime: 7, author: 'Nasheta John', views: 1956, categories: ['Casino Reviews', 'Industry News'] },
    { slug: 'igaming-content-mistakes', title: 'The iGaming Content Mistakes Quietly Killing Rankings', excerpt: 'Thin affiliate copy, missing compliance context, and weak internal linking — the most common issues.', image: 'assets/images/blog-seo.jpg', date: new Date('2026-05-05'), readTime: 8, author: 'Nasheta John', views: 3421, categories: ['Content Strategy', 'SEO'] },
    { slug: 'south-africa-gambling-tax', title: "University of Cape Town Academics Back Online Gambling Tax Increase In South Africa", excerpt: "UCT researchers have backed South Africa's proposed 20% online gambling tax, arguing that the country's betting boom is creating growing financial and social harm.", image: 'assets/images/blog-south-africa.jpg', date: new Date('2026-05-28'), readTime: 4, author: 'Kolade Abisoye', views: 4521, categories: ['Industry News', 'Regulations'] },
    { slug: 'accumulator-bets-explained', title: 'Accumulator Bets Explained: What To Know Before Your Next Parlay', excerpt: 'A clear Betting IQ guide explaining accumulator bets, how they work in football betting, risk factors and what African bettors must understand before making decisions.', image: 'assets/images/blog-accumulator.jpg', date: new Date('2026-05-28'), readTime: 5, author: 'John Raymond', views: 3187, categories: ['Betting IQ', 'Betting Basics'] },
    { slug: 'kenya-gambling-tax-fight', title: "Kenya's Gambling Tax Fight Exposes Gap In Regulatory Framework", excerpt: "Kenya's gambling regulator is opposing plans to reintroduce a 20% tax on betting winnings, warning that modern bonus systems make the proposal difficult to enforce.", image: 'assets/images/blog-kenya-tax.jpg', date: new Date('2026-05-28'), readTime: 4, author: 'Kolade Abisoye', views: 2734, categories: ['Sports Betting', 'Industry News'] }
  ];
