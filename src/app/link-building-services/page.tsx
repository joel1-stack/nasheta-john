      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10">
          {[
            ...
            { label: "Translation", href: "/translation-services" },
            { label: "Editing", href: "/editing-services" },
            { label: "Link Building", href: "/link-building-services", active: true },
          ].map((tab) => (
            <Link
              key={tab.label}
              href={tab.href}
        ...
        <section className="relative rounded-2xl overflow-hidden p-8 md:p-12 text-white text-center">
          <div className="absolute inset-0">
            <img src="/images/sports betting analytics.png" alt="" width={1244} height={700} loading="lazy" className="w-full h-full object-cover" />
